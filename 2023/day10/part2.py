...
def main() -> None:
    ...
    answer = get_number_of_enclosed_locations(loop_locations, location_map)
...
def get_number_of_enclosed_locations(
    loop_locations: set[Location], location_map: LocationMap
) -> int:
    ...  # TODO
